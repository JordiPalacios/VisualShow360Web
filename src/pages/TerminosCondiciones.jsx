    ...
    <>
        ...
        <main>            
            <div className='normativityContainer'>
                ...
                <p>
                    ¡Bienvenido a <span style={{ color: 'var(--accent)' }}>VisualShow360</span>!
                    <br />
                    <br />
                    Estos términos y condiciones describen las reglas y regulaciones para el uso del sitio web de VisualShow360, ubicado en <NewPage href="/" label='https://visualshow360.com'/>.
                    <br />
                    <br />
                    ...
                    No debes:
                    <br />
                    Copiar o volver a publicar material de VisualShow360 <br />
                    Vender, alquilar o sublicenciar material de VisualShow360 <br />
                    Reproducir, duplicar o copiar material de VisualShow360 <br />
                    Redistribuir contenido de VisualShow360 <br />
                    ...
                    <br />
                    <br />
                    VisualShow360 se reserva el derecho de monitorear todos los comentarios y eliminar los que puedan considerarse inapropiados, ofensivos o que incumplan estos <NewPage href="/terminos-condiciones" label='Términos y Condiciones'/>.
                    <br />
                    <br />
                    ...
                    <br />
                    <br />
                    Si eres una de las organizaciones enumeradas en el párrafo 2 y estás interesada en vincularte a nuestro sitio web, debes informarnos enviando un correo electrónico a <span style={{ color : 'var(--accent)'}}>contacto@visualshow360.com</span>. Incluye tu nombre, el nombre de tu organización, la información de contacto, así como la URL de tu sitio, una lista de las URL desde las que tienes la intención de vincular a nuestro sitio web y una lista de las URL de nuestro sitio a las que te gustaría acceder. Espera 2-3 semanas para recibir una respuesta.
                    <br />
                    <br />
